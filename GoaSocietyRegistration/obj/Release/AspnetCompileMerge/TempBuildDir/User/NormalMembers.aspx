<%@ Page Title="" Language="C#" MasterPageFile="~/User/Society.Master" AutoEventWireup="true" CodeBehind="NormalMembers.aspx.cs" Inherits="GoaSocietyRegistration.User.NormalMembers" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
 ...
 <%--   <script type="text/javascript">
        $(document).ready(function () {
            var va = $('#TxtBxDocumentNo').val(); alert(va);
            $('.value1').on('keydown keyup mousedown mouseup', function () {
                 
                var CCNValue = $(this).val();               
                $("#<%= hfencryptNo.ClientID %>").val($('#<%= TxtBxDocumentNo.ClientID %>').val());
                $('#TxtBxDocumentNo').html(CCNValue);                 
            $(this).val(CCNValue.substring(0, 8).replace(/\d/g, "X") + CCNValue.substring(8));
        });
    });
    </script> --%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card" style="width: 100%;">
                    <h4 class="card-header"><strong>Member Details </strong><strong id="renewhead1" runat="server" visible="false">(Schedule VI) </strong><strong>:: </strong></h4>
                    <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <div class="table table-bordered table-hover">
                                        ...
                                        <thead>
                                            <tr>
                                                <td colspan="6" style="text-align: center">
                                                    <asp:Button ID="Button1" OnClientClick="CoverClickLK('Button1');" CausesValidation="false" CssClass="btn btn-primary" runat="server" OnClick="Button1_Click" Text="Add Member Details  " />
                                                </td>
                                            </tr>
                                            <tr>
                                                        ...
                                                        <asp:GridView ID="grvMemberDetails" runat="server" CellPadding="3" OnRowDataBound="grvMemberDetails_RowDataBound" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" OnPageIndexChanging="grvMemberDetails_PageIndexChanging" Font-Size="Small" AlternatingRowStyle-CssClass="alt" PagerStyle-CssClass="pgr" EmptyDataText="No Record Found." ShowHeaderWhenEmpty="true">
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Edit">
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton ID="LBUpdate" OnClick="LBUpdate_Click" CausesValidation="false" runat="server"><i class="far fa-edit" ></i></asp:LinkButton>
                                                                        <asp:HiddenField ID="hfdesignid" Value='<%# Eval("design") %>' runat="server" />
                                                                        <asp:HiddenField ID="hfmangcomm" Value='<%# Eval("mangcomm") %>' runat="server" />
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField HeaderText="Edit" Visible="false">
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <asp:Label ID="lbmember_proof_id" runat="server" Text='<%# Eval("proofid") %>'></asp:Label>
                                                                        <asp:Label ID="lbmember_memberid" runat="server" Text='<%# Eval("member_id") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
                                                            <EmptyDataTemplate>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Label runat="server" ID="lblTotMembers" CssClass="col-sm-3 col-form-label mylabel" Text="Total number of Members"></asp:Label></td>
                                                <td colspan="5">
                                                    <asp:HiddenField ID="totalMember" runat="server" />
                                            ...
                                            <tr id="memberupload" runat="server" visible="false">
                                                ...
                                                <td id="listupload" runat="server">
                                                    <asp:LinkButton ID="LB_memberslist_upload" OnClientClick="CoverClickLK('LB_memberslist_upload');" CausesValidation="false" runat="server" ToolTip="Upload File"><i class="fa fa-upload" ></i></asp:LinkButton></td>
                                                <td id="listdelete" runat="server">
                                                    <asp:LinkButton ID="LB_memberslist_delete" OnClientClick="CoverClickLK('LB_memberslist_delete');" CausesValidation="false" runat="server" ToolTip="Delete File"><i class="fa fa-trash"></i></asp:LinkButton></td>
                                                <td>
                                                    <asp:LinkButton ID="LB_memberslist_view" OnClientClick="CoverClickLK('LB_memberslist_view');" CausesValidation="false" runat="server" ToolTip="View File"><i class="fa fa-file-pdf" aria-hidden="true"></i></asp:LinkButton></td>
                                                <td>
                                    ...
                                    <table style="width: 100%" class="table-borderless">
                                        <tr>
                                            <td>
                                                <asp:Button ID="btnBack" OnClientClick="CoverClickLK('btnBack');" runat="server" Text="Back" CssClass="btn btn-warning" OnClick="btnBack_Click" CausesValidation="false" /></td>
                                            <td>
                                                <asp:Button ID="nextbtn" OnClientClick="CoverClickLK('nextbtn');" runat="server" Text="Next" Style="float: right" OnClick="nextbtn_Click" CssClass="btn btn-primary" CausesValidation="false" /></td>
                                    ...
                                    <div class="table table-bordered table-hover">
                                        <table style="width: 100%">
                                            <thead>
                                                ...
                                                <tr>
                                                    <td class="a">
                                                        <asp:Label runat="server" ID="lbl_age" Text="Age" CssClass="control-label" autocomplete="off" AutoCompleteType="Disabled" Font-Bold="true"></asp:Label><span class="text-danger">*</span>
                                                    </td>
                                                    <td class="b">
                                                ...
                                                <tr id="row_DesignOthers" runat="server" visible="false">
                                                    ...
                                                    <td class="b">
                                                        <asp:TextBox ID="TxtBx_DesignOthers" CssClass="form-control" runat="server" MaxLength="100" autocomplete="off" AutoCompleteType="Disabled"></asp:TextBox>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="b">
                                                        <asp:TextBox ID="txt_MemAddress" CssClass="form-control" runat="server" MaxLength="100" autocomplete="off" AutoCompleteType="Disabled"></asp:TextBox>
                                                ...
                                                <tr id="trvisible" runat="server">
                                                    ...
                                                    <td class="b">
                                                        <asp:TextBox runat="server" ID="TxtBxDocumentNo" autocomplete="off" AutoCompleteType="Disabled" MaxLength="50" CssClass="value1 form-control"></asp:TextBox>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="b">
                                                        ...
                                                        <div class="alert alert-info" role="alert">
                                                            Not a part of Managing Committee
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td></td>
                                                    <td>
                                                        <asp:Button ID="btnUpdate" OnClientClick="CoverClickLK('btnUpdate');" CssClass="btn btn-primary" Visible="false" runat="server" Text="Update" OnClick="btnUpdate_Click" />
                                                        <%--CausesValidation="false"--%>
                                                        <asp:Button ID="btnAdd" OnClientClick="CoverClickLK('btnAdd');" CssClass="btn btn-primary" runat="server" Text="Add" OnClick="btnAdd_Click" /><%--CausesValidation="false"--%>
                                                        <asp:Button ID="btnAddOld" OnClientClick="CoverClickLK('btnAddOld');" CssClass="btn btn-info" runat="server" Text="Add" OnClick="btnAddOld_Click" /><%--CausesValidation="false"--%>
 ...
 <%--     <script> 
        $(document).ready(function () {
            // Function to mask Aadhar digits
            function maskAadhar(value) {
                // Check if the value is valid Aadhar (12 digits)
                if (/^\d{12}$/.test(value)) { 
                    // Mask all but the last 4 digits
                    return 'XXXXXXXX' + value.substring(8);
                }
                return value; // Return original value if not Aadhar format
            }
            // Function to unmask Aadhar digits
            function unmaskAadhar(value) { 
                // Remove non-digit characters and return
                return value.replace(/\D/g, '');
            }
            // On input in Aadhar textbox
            $('#ContentPlaceHolder1_TxtBxDocumentNo').on('input keydown keyup mousedown mouseup', function () {
                var maskedValue = maskAadhar(this.value);
                $('#ContentPlaceHolder1_TxtBxDocumentNo').val(maskedValue); // Set masked value
                $('#ContentPlaceHolder1_originalAadhar').val(unmaskAadhar(maskedValue)); // Set original value  
