<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Feedback.aspx.cs" Inherits="GoaSocietyRegistration.Feedback" %>
...
<body class="home page-template-default page page-id-3371 mva7-thc-activetheme-district-theme lang-en wpb-js-composer js-comp-ver-5.4.7 vc_responsive" style="font-size: 14px !important">
    <form id="form1" runat="server">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="table-responsive">
                            <table class="mycenter">
                                ...
                                <tr>
                                    <td>Sender Name&nbsp;<span class="text-danger">*</span></td>
                                    <td>
                                        <asp:TextBox ID="TxtBxName" runat="server"></asp:TextBox>
                                   <asp:RequiredFieldValidator ID="rfvfname" runat="server" Display="Dynamic" CssClass="text-danger" ControlToValidate="TxtBxName" ErrorMessage="Enter Name"> </asp:RequiredFieldValidator>
                                  <asp:RegularExpressionValidator ID="revfirstname" runat="server" Display="Dynamic" ControlToValidate="TxtBxName" ForeColor="Red" ValidationExpression="[\sa-zA-Z`]*$" ErrorMessage="Invalid Name" />
                                                  </td>
                                    <asp:HiddenField ID="HiddenField1" runat="server" />
                                </tr>
                                <tr>
                                    <td>Sender Email&nbsp;<span class="text-danger">*</span></td>
                                    <td>
                                        <asp:TextBox ID="TxtEmail" runat="server"></asp:TextBox>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TxtEmail" ForeColor="Red" ValidationExpression="^([\w-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([\w-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$" Display="Dynamic" ErrorMessage="Invalid email address" />
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TxtEmail" ForeColor="Red" Display="Dynamic" ErrorMessage="Enter email" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="TxtBxMobile" MaxLength="10" runat="server"></asp:TextBox>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TxtBxMobile" CssClass="text-danger" Display="Dynamic" ValidationExpression="[6-9][0-9]{9}" ErrorMessage="Invalid Mobile No." />
                                         <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TxtBxMobile" ForeColor="Red" Display="Dynamic" ErrorMessage="Enter mobile no" />
                                          <asp:HiddenField ID="HDmobile" runat="server" />
                                    </td>

                                </tr>
                                <tr>
                                    <td>Feedback&nbsp;<span class="text-danger">*</span></td>
                                    <td>
                                        <asp:TextBox ID="TxtFeedback" TextMode="MultiLine" Rows="3" runat="server"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtbxcaptcha" ValidationGroup="a" AutoCompleteType="Disabled" MaxLength="6" CssClass="form-control" runat="server" ToolTip="Captcha" placeholder="Captcha"></asp:TextBox>
                                ...
                                <tr>
                                    <td>
                                        <asp:LinkButton ID="LkBtnSubmit" OnClientClick="coconut()" OnClick="LkBtnSubmit_Click" CssClass="btn btn-info" runat="server">Submit</asp:LinkButton>
                                    </td>
                                    <td>
                                        <asp:LinkButton ID="LkBtnCancel" CssClass="btn-danger btn" OnClick="LkBtnCancel_Click" runat="server">Cancel</asp:LinkButton>
                                    </td>
                                </tr>
                            </table>
                            <asp:Label ID="lberror" CssClass="text-danger" runat="server" Text=""></asp:Label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="copyRights">
                    ...
                    <div class="copyRightsText">
                        ...
                        <p>Last Updated: <strong>October 5, 2020</strong></p>
                    ...
                    <div class="modal-content">
                        <div class="modal-header" style="background-color: #607D8B">
                            <h4 class="modal-title">
                                <asp:Label ID="Label1" runat="server" Text="Alert" ForeColor="White"></asp:Label>
                            </h4>
                        </div>
                        ...
                        <div class="modal-footer">
                              <asp:LinkButton ID="LinkButton1" OnClick="LinkButton1_Click" runat="server">Close</asp:LinkButton>
        ...
        <div class="bs-example">
            <!-- Modal HTML -->
            <div id="feedbackerror" class="modal">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header" style="background-color: #607D8B">
                            <h4 class="modal-title">
                                <asp:Label ID="Label19" runat="server" Text="Alert" ForeColor="White"></asp:Label>
                            </h4>
                        </div>
                        <div class="modal-body">
        ...
        <script>
            function coconut() {
                ...
                var uname = document.getElementById("<%=TxtBxMobile.ClientID %>").value.trim();
            ...
            if (uname == "") errPass.html(" Mobile No Required !");
                ...
                if (Boolean(mobs)) {
                    ...
                    document.getElementById("<%=TxtBxMobile.ClientID %>").disabled = true;

                } else {
                    enablefields();
                }
            }
            var uemail = document.getElementById("<%=TxtEmail.ClientID %>").value.trim();
            CheckMobileNo("MAL");
        }//End ready()
        ...
        <script type="text/javascript">
            ...
            function CheckMobileNo(inputIdentifier) {
                ...
                var mobileno = document.getElementById("<%=TxtBxMobile.ClientID %>").value.trim();
                var encryptedlogin = CryptoJS.AES.encrypt(CryptoJS.enc.Utf8.parse(mobileno), key,
               {
                ...
                if (encryptedlogin != null && encryptedlogin != "") {
                    ...
                    $('#<%=HDmobile.ClientID %>').val(encryptedlogin);
                    return true;
                } else {
            ...
            } else if (inputIdentifier == "MAL") {
                var key = CryptoJS.enc.Utf8.parse('<%=Session["Enc_Random"]%>');
                var iv = CryptoJS.enc.Utf8.parse('<%=Session["Enc_Vector"]%>');
                var emailids = document.getElementById("<%=TxtEmail.ClientID %>").value.trim();
                var encryptedemail = CryptoJS.AES.encrypt(CryptoJS.enc.Utf8.parse(emailids), key,
               {
                   keySize: 128 / 8,
                   iv: iv,
                   mode: CryptoJS.mode.CBC,
                ...
                $('#<%=HDemail.ClientID %>').val(encryptedemail);
                return true;
            }
